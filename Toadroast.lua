...
sky = coroutine.create(function()
	while wait(0.3) do
		...
		s.SkyboxBk, s.SkyboxDn, s.SkyboxFt, s.SkyboxLf, s.SkyboxRt, s.SkyboxUp = 
			"rbxassetid://201208408", "rbxassetid://201208408", "rbxassetid://201208408",
			"rbxassetid://201208408", "rbxassetid://201208408", "rbxassetid://201208408"
...
msg = coroutine.create(function()
	while wait(0.4) do
		...
		msg.Text = "EVERYTHING 4 NOTTI BITCH"
		wait(0.4)
		msg:Destroy()
	end
end)
...
sound.Name = "Sound"
sound.SoundId = "http://www.roblox.com/asset/?id=6153817247" -- Song
sound.Volume = .9999999999999999999999999999999999999999999999999999999999999999999 -- Derp
